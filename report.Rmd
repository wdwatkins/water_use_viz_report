...
#new for shoemaker award app
zoom_or_cat_ids <- unique(c(zoom_change_ids, cat_change_ids))
interacted_df <- tibble(eventLabel = "changed zoom or category",
                        fraction_of_sessions = round(length(zoom_or_cat_ids)/total_sessions, digits = 2))
